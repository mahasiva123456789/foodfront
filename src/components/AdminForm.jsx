...
const AdminForm = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const newHotel = { hotelImage, hotelName, hotelPlace, hotelTime, hotelRating };
            ...
            <div className="admincontent">
                <div className="left-container">
                    <form onSubmit={handleSubmit} className="form-group">
                        ...
                        <input type="text" value={hotelImage} onChange={(e) => setHotelImage(e.target.value)} className="input-field1" required />
                        <br /><br />
                        <label className="label">Hotel Name:</label>
                        <input type="text" value={hotelName} onChange={(e) => setHotelName(e.target.value)} className="input-field2" required />
                        <br /><br />
                        <label className="label">Place:</label>
                        <input type="text" value={hotelPlace} onChange={(e) => setHotelPlace(e.target.value)} className="input-field3" required />
                        <br /><br />
                        <label className="label">Opening Time:</label>
                        <input type="text" value={hotelTime} onChange={(e) => setHotelTime(e.target.value)} className="input-field4" required />
                        <br /><br />
                        <label className="label">Rating:</label>
                        <input type="text" value={hotelRating} onChange={(e) => { if (/^\d*\.?\d*$/.test(e.target.value) || e.target.value === '') setHotelRating(e.target.value); }} className="input-field5" required />
                        <br /><br />
                        <button type="submit" className="submit-button">{editIndex !== null ? 'Update Hotel' : 'Add Hotel'}</button>
                    </form>
